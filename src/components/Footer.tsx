...
const Footer = () => {
  ...
  return (
    <div 
      className="bg-cover bg-center p-5 relative"
      ...
      <div className="relative z-10">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-5 md:mb-0">
            ...
            <div className="w-16 bg-blue-400 h-1 my-2" />
            <div className="text-white text-lg">
              {Locations.map((location, index) => (
                <div key={index} className="flex items-center mb-2">
                  <location.location className="text-red-500 mr-2" />
            ...
            <div className="text-white text-lg">
              {NavigationItemsRoutes.map((route, index) => (
                <Link
                  href={route.path}
                  key={index}
                  className="block hover:text-blue-300 mb-1"
                >
                  {route[language]}
                </Link>
              ))}
              ...
              {Contacts.map((contact, index) => (
                <div key={index} className="flex justify-between mb-2">
                  ...
                  <div className="flex items-center">
                    <contact.icon className="text-blue-300 mr-2" />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-5">
          <div className="flex items-center gap-3 mb-4 md:mb-0 bg-white rounded">
            ...
            <SiSpringsecurity className="w-7 h-7 text-blue-600" />
          </div>
          ...
          <div className="bg-blue-700 p-3 rounded-lg">
            ...
            <div className="flex gap-5 justify-around mt-2">
              ...
              <a href="#" className="text-red-500 hover:animate-bounce">
                <FaYoutube />
              </a>
              <a
                ...
                className="text-blue-300 hover:animate-bounce"
              >
                <FaLinkedin />
              </a>
              <a
                ...
                className="text-orange-400 hover:animate-bounce"
              >
                <FaInstagram />
              </a>
              <a
